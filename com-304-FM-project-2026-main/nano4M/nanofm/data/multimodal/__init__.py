...
def create_multimodal_masked_dataloader(
    ...
    image_token_grid_sizes: Optional[dict] = None,
    ...
    Args:
        ...
        masking_strategy: Target-position masking strategy. Supports random, span,
            block, structured, and mixed.
        structured_mask_probability: Probability of using span/block when applicable.
            Lower values mix structured masking with the random baseline.
        ...
        image_token_grid_sizes: Optional per-modality image-token grid sizes.
        span_geometric_p: Geometric span length success probability.
        block_min_size: Minimum sampled block height/width in tokens.
        block_max_fraction: Maximum sampled block height/width as a fraction of grid size.
    ...
    masking_transforms = SimpleMultimodalMasking(
        ...
        structured_mask_probability=structured_mask_probability,
        ...
        block_max_fraction=block_max_fraction,
    )
